            ...
            <Container fluid={true}>
             <Row>
                <Column extraSmall={ 10 }
                    ...
                    large={ 10 }
                    largeOffset={ 10 } > 
                    <a   href={"#businesses/" + this.props.business.id}>
                     
                    <b>{this.props.business.Name}</b>
                    <p>{this.props.business.desc}</p>
...
<Header text="ZenDesi.com" back="false"/>
    <div className="content">
                ...
                {this.state.categories.map(function(categories) {
                   ...
                   <a className='col-xs-4 col-sm-6 col-md-3 col-lg-4 grid-left'   href={"#business/" + categories.name} >
                    <img className="media-object big center" src={"pics/" + categories.img}/> 
                    <p className='col-md-10' style={{'textAlign': 'pull-left'}}>{categories.name} </p>
                    <p className='col-md-10' style={{'textAlign': 'pull-left'}}>{} </p>
                   </a>
        ...
        return (
            <div className={"page " + this.props.position}>
                ...
                <div className="content table-view">
                        ...
                        <div className="table-view-cell media">
                            <a href={"tel:" + this.state.business.mobilePhone} className="push-right">
                                <span className="media-object pull-left icon icon-call"></span>
                                <div className="media-body fixedSize">
                                Call
                                    <p>{this.state.business.mobilePhone}</p>
                                </div>
                            </a>
                        </div>
